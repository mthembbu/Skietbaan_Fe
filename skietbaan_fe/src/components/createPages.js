          ...
          <div className="create-main-container">
                ...
                >
                  ...
                  <Row className="row justify-content-center">
                    <div
                      ...
                      style={{ boxShadow: this.noShadowOnMember() }}
                    >
                      {" "}
            ...
            <div className="components-create">
              {this.state.selectedButton === 1 && this.props.page === 10 ? (
                <AddGroup />
              ) : (this.state.selectedButton === 1 && this.props.page === 0) ||
                (this.state.selectedButton === 1 && this.props.page === 1) ||
                (this.state.selectedButton === 1 && this.props.page === 2) ? (
                <GroupComponent />
              ) : null}
...
export default connect(
  mapStateToProps,
  { compSelectedPages, pageState, selectedPage }
)(createPages);
