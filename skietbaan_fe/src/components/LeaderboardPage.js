                                                                                         ...
                                                                                         <tr className="user-details-row">
                                                                                             <td className="rank-icon-col">
                                                                                                 <div className="rank-number-container">
                                                                                                     <div className="member-status-icons">
                                                                                                         <div className="membership-icon">
                                                                                                             {this.props.currentUser !== null ? (this.props.currentUser.memberID === null || this.props.currentUser.memberID ==""
                                                                                                                 ? <img src={require('../resources/guestW.png')} />
                                                                                                                 : <img src={require('../resources/memberW.png')} />) : this.props.userResults !== null ? (this.props.userResults.isMember ? <img src={require('../resources/memberW.png')} />
